...
const Footer: React.FC = () => {
  return (
    // Added 'relative z-10' to lift footer above fixed backgrounds
    <footer className="relative z-10 border-t border-slate-800 bg-surface-950 pt-16 pb-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          {/* ... existing grid content ... */}
           <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-slate-400 text-sm leading-relaxed">Connecting ambitious professionals with world-class mentors.</p>
          </div>
