  ...
  return (
    <main className="min-h-screen pt-24 pb-16">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <motion.button initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} onClick={() => navigate(-1)} className="flex items-center gap-2 text-slate-400 hover:text-white transition-colors mb-8 group">
                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {mentor.skills.map((skill, index) => (
                      <span key={index} className="px-3 py-1 bg-slate-800 text-slate-300 rounded-lg text-sm border border-slate-700 hover:border-brand-500/50 transition-colors">{skill}</span>
                    ))}
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-slate-700 shadow-2xl shadow-brand-500/5">
                <CardContent className="p-6 space-y-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3 text-slate-300"><CheckCircle size={18} className="text-accent-emerald" /><span>45-minute 1-on-1 session</span></div>
                    <div className="flex items-center gap-3 text-slate-300"><CheckCircle size={18} className="text-accent-emerald" /><span>Virtual or Physical meeting</span></div>
                    <div className="flex items-center gap-3 text-slate-300"><CheckCircle size={18} className="text-accent-emerald" /><span>Session notes & resources</span></div>
                  </div>
